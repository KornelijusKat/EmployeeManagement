...
.taskTable tr:hover {
    ...
    <asp:PlaceHolder ID="tasksTablePlaceholder" runat="server"></asp:PlaceHolder>
  ...
  <asp:Literal runat="server" ID="tasksLiteral"></asp:Literal>
</table>
    <asp:Button ID="btnCreateTask" runat="server" Text="Submit" onClick="btnCreateTask_Click" Visible="false" />
    <asp:Button ID="btnEditTask" runat="server" Text="Submit" onClick="btnCreateTask_Click" Visible="false" />
</asp:Content>